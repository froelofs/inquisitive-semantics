...
practicalities:
  - label: Time and place
    text: Mondays 14.30-17.15 (Hasbrouck Lab Add 104A)
people: [froelofsen]
description: >
...
- First-order case: [Ciardelli-09a]({{ site.baseurl }}/assets/files/theses/Ciardelli2009_InquisitiveSemanticsAndIntermediateLogics.pdf), chapter 6, and [Ciardelli-09b]({{ site.baseurl }}/assets/files/papers/Ciardelli2009_AC.pdf).
